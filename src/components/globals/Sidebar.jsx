...
const Sidebar = () => {
    ...
    return (
        <aside
            className={`${screenWidth < 650 ? "-translate-x-[100%] shadow-md" : "shadow-none"} w-64 font-dmSans bg-white fixed border-r top-[60px] md:top-[65px] left-0 z-40 transition-transform md:transition-none bottom-0`}
            aria-label="Sidenav">
            <div
