...
import lyncslogo2 from "../../assets/images/lyncslogo2.png"

function Navbar({ handleToggle }) {
    // const { data, updateData } = useSignupStore((state) => state);
    const data = [];
    const [toggle, setToggle] = useState({ notification: false, apps: false, profile: false, sidebar: false });
    // const { logout, user } = useAuth();
    const handleClick = (e) => {
        setToggle((prevState) => ({ ...prevState[false], [e]: !prevState[e] }))
    }
        ...
        useEffect(() => {
            ...
            function handleClickOutside(event) {
                if (ref.current && !ref.current.contains(event.target)) {
                    setToggle({ notification: false, apps: false, profile: false, sidebar: false })
                }
            }
    ...
    return (
        <header ref={wrapperRef}>
            <nav className="bg-white border px-4 lg:px-6 py-2.5 z-50 fixed top-0 w-full font-dmSans">
                <div className="flex flex-wrap justify-between items-center">
                    <div className="flex justify-start items-center">
                        {/* <button onClick={handleToggle} id="toggleSidebar" aria-expanded="true" aria-controls="sidebar"
                            className="hidden p-2 mr-3 text-gray-600 rounded cursor-pointer lg:inline hover:text-gray-900 hover:bg-gray-700 hover:text-gray-100">
                        ...
                        <button onClick={handleToggle} aria-expanded="true" aria-controls="sidebar"
                            className="p-2 mr-2 text-gray-600 rounded-lg cursor-pointer lg:hidden hover:text-gray-100 focus:text-gray-100 hover:bg-gray-700 focus:bg-gray-700">
                            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h6a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z"
                        ...
                        <Link className="flex mr-4" to="/">
                            <img src={lyncslogo2} className="mr-3 h-7 hidden md:block"
                                alt="Logo" />
                            <img src={lyncslogo2} className="mr-3 h-6 md:hidden"
                                alt="Logo" />
                    ...
                    <div className="flex items-center lg:order-2">
                        ...
                        <button onClick={() => handleClick("notification")} type="button" data-dropdown-toggle="notification-dropdown"
                            className="p-2 mr-1 text-gray-500 rounded-lg hover:text-white">
                        ...
                        <div
                            className={`${toggle.notification ? 'block' : 'hidden'} fixed w-full top-[3.1rem] right-0 overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg`}
                            ...
                            <div>
                                <a href="#"
                                    ...
                                    <div className="pl-3 w-full">
                                        <div className="text-gray-500 font-normal text-sm mb-1.5 ">New
                                            message from <span className="font-semibold text-gray-900">Bonnie Green</span>:
                                            "Hey, what's up? All set for the presentation?"
                                        </div>
                                        <div className="text-xs font-medium text-primary-700">a
                                            few moments ago
                                        </div>
                                    </div>
                                </a>
                                <a href="#"
                                    ...
                                    <div className="flex-shrink-0">
                                        ...
                                        <div
                                            className="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 bg-gray-900 rounded-full border border-white">
                                            <svg className="w-3 h-3 text-white"
                                                fill="currentColor" viewBox="0 0 20 20"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <div className="pl-3 w-full">
                                        ...
                                        <div className="text-xs font-medium text-primary-700">10
                                            minutes ago
                                        </div>
                                    </div>
                                </a>
                                <a href="#"
                                    ...
                                    <div className="pl-3 w-full">
                                        <div className="text-gray-500 font-normal text-sm mb-1.5 ">
                                            <span
                                                className="font-semibold text-gray-900">Joseph Mcfall</span> and <span
                                                    className="font-medium text-gray-900">141 others</span> love
                                            your story. See it and view more stories.
                                        </div>
                                        <div className="text-xs font-medium text-primary-700">44
                                            minutes ago
                                        </div>
                                    </div>
                                </a>
                                    ...
                                    <div className="pl-3 w-full">
                                        <div className="text-gray-500 font-normal text-sm mb-1.5 ">
                                            ...
                                            you in a comment: <span
                                                className="font-medium text-primary-700">@bonnie.green</span> what
                                            do you say?
                                        </div>
                                        <div className="text-xs font-medium text-primary-700">1
                                            hour ago
                                        </div>
                                    </div>
                                </a>
                                <a href="#" className="flex py-3 px-4 hover:bg-gray-100">
                                    ...
                                    <div className="pl-3 w-full">
                                        <div className="text-gray-500 font-normal text-sm mb-1.5 ">
                                            <span
                                                className="font-semibold text-gray-900">Robert Brown</span> posted
                                            a new video: Glassmorphism - learn how to implement the new design trend.
                                        </div>
                                        <div className="text-xs font-medium text-primary-700">3
                                            hours ago
                                        </div>
                                    </div>
                                </a>
                            ...
                            <a href="#"
                                ...
                                <div className="inline-flex items-center ">
                                    <svg className="mr-2 w-5 h-5" fill="currentColor"
                                        viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button onClick={() => handleClick("apps")} type="button" data-dropdown-toggle="apps-dropdown"
                        ...
                        <div
                            className={`${toggle.apps ? 'block' : 'hidden'}  fixed w-full top-[3.1rem] right-0 overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg`}
                            id="apps-dropdown">
                            <div
                                className="block py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-50 ">
                                Apps
                            ...
                            <div className="grid grid-cols-3 gap-4 p-4">
                                ...
                                <a href="#"
                                    ...
                                    {/* <div onClick={logout} className="text-sm text-gray-900">Logout</div> */}
                                </a>
                            </div>
                        </div>
                        <button onClick={() => handleClick("profile")} type="button"
                        ...
                        <div
                            className={`${toggle.profile ? 'block' : 'hidden'}  fixed w-full top-[3.1rem] right-0 z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow`}
                            id="dropdown">
                            ...
                            <ul className="py-1 font-light text-gray-500 " aria-labelledby="dropdown">
                                <li>
                                    <a href="#"
                                        className="block py-2 px-4 text-sm hover:bg-gray-100  ">My
                                        profile</a>
                                </li>
                                <li>
                                    <a href="#"
                                        className="block py-2 px-4 text-sm hover:bg-gray-100  ">Account
                                        settings</a>
                                </li>
                            </ul>
                            <ul className="py-1 font-light text-gray-500 " aria-labelledby="dropdown">
                            ...
                            <ul className="py-1 font-light text-gray-500 " aria-labelledby="dropdown">
                                {/* <li>
                                    <a onClick={logout} href="#"
                                        className="block py-2 px-4 text-sm hover:bg-gray-100 ">Sign
                                        out</a>
                                </li> */}
                            </ul>
                        </div>
